...
import com.fastcampus.boardpractice.dto.response.ArticleResponse;
import com.fastcampus.boardpractice.dto.response.ArticleWithCommentsResponse;
...
@RequestMapping("/articles") //RequestMapping으로 url설정이 가능하다
@Controller
